...
log4js.configure({
    ...
    appenders: [
        ...
        },
        {
            category: 'log_file',
            type: 'file',
            filename: './logs/test.log',    //文件目录，当目录文件或文件夹不存在时，会自动创建
            maxLogSize: 10,                 //文件最大存储空间，当文件内容超过文件存储空间会自动生成一个文件test.log.1的序列自增长的文件,字节为单位
        ...
        },
        {
            category: "log_date",
            type: "dateFile",
            filename: './logs/dateFileTest',//您要写入日志文件的路径
